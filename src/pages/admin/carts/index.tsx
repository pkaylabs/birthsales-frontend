...
export default function CartPage() {
  ...
  const handleCheckout = () => {
    ...
    // Logic to move cart items to Orders Page can be implemented
  };
      ...
      <Card style={{ marginBottom: "1rem" }}>
        <CardContent>
          ...
          <Typography variant="h6">
            Total Price: GH₵{cart.reduce((total, item) => total + item.price * item.quantity, 0)}
          </Typography>
        </CardContent>
      </Card>
          ...
          <TableBody>
            {cart.map(item => (
              <TableRow key={item.id}>
                ...
                <TableCell>
                  <Button color="secondary" onClick={() => handleRemoveItem(item.id)}>
                    Remove
                  </Button>
                </TableCell>
              </TableRow>
...
//     lastUpdated: "2025-01-02 12:30 PM",
//     totalAmount: "$120",
//     cartStatus: "Active",
//   },
...
//               onClick={() => navigate({ to: "/products/test" })}
//             >
//               View
//             </div>
...
//     setTimeout(() => {
//       setRows(userRows);
//       setLoading(false); // Only set false after data is ready
