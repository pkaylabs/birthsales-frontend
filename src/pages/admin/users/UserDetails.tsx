...
export default function UserDetailsPage() {
  // Retrieve route parameters using react-location's useMatch hook
  ...
  // Filtering the transaction associated with this user;
  const transaction = transactions.filter((tx) => tx.userId === user.id);
