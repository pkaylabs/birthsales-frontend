...
// import Dropdown from "./sidebar-dropdown"; // your dropdown component
...
//   return (
//     <>
//       {/* Toggle Button – visible only on screens below desktop-up */}
//       <div className="mobile:block desktop-up:hidden fixed top-0 left-0 p-4 z-[100] flex justify-between items-center">
//         <button
...
//       {/* Off-canvas Sidebar – visible only on screens below desktop-up */}
//       <aside
//         className={`fixed top-0 left-0 h-full w-64 bg-white shadow-lg z-50 transform transition-transform duration-300 desktop-up:hidden ${
