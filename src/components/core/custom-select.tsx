  ...
  return (
    <Listbox value={selectedItem} onChange={onChange}>
      ...
      <div className="relative mt-2">
        <ListboxButton className="grid w-full cursor-default grid-cols-1 rounded-md bg-white py-2.5 pl-3 pr-2 text-left text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300  sm:text-sm/6">
